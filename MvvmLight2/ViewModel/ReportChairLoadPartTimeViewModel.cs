...
{
    public class ReportChairLoadPartTimeViewModel : WorkspaceViewModel
    {
        ...
        /// <summary>
        /// Initializes a new instance of the ReportChairLoadPartTimeViewModel class.
        /// </summary>
        public ReportChairLoadPartTimeViewModel(IServiceLoadChair service)
        {
            ...
            base.DisplayName = "Отчет Нагрузка кафедры - заочное отделение";
        ...
        private void GetLoadChairExecute()
        {
                ...
                (SelectedNameLoadChair != null))
            {
                ...
                worker.DoWork += (o, ea) =>
                {
                loadChairTeaching = loadChairService.GetLoadChairTeachingPartTime(SelectedChair.Id,
