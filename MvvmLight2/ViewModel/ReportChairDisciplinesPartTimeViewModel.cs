...
{
    public class ReportChairDisciplinesPartTimeViewModel : WorkspaceViewModel
    {
        private MvvmLight2.Helper.IContainer container = MvvmLight2.Helper.Container.Instance;

        ObservableCollection<tlsp_getDisciplineChairPartTime_Result> disciplines;
        ...
        public ObservableCollection<tlsp_getDisciplineChairPartTime_Result> Disciplines { get; private set; }
        ...
        /// <summary>
        /// Initializes a new instance of the ReportChairDisciplinesPartTimeViewModel class.
        /// </summary>
        public ReportChairDisciplinesPartTimeViewModel()
        {
            Disciplines = new ObservableCollection<tlsp_getDisciplineChairPartTime_Result>();
            base.DisplayName = "Отчет Дисциплины кафедры - заочное обучение";
        }
        ...
        public void GetExecuteDisciplines()
        {
            ...
            if ((SelectedChair != null) && (SelectedAcademicYear != null))
            {
                ...
                worker.DoWork += (o, ea) =>
                {
                    disciplines = service.GetDisciplinePartTime(selectedChair.Id, selectedAcademicYear.Id);
                };
