...
{
    public class ReportChairLoadFullTimeViewModel : WorkspaceViewModel
    {
        ...
        /// <summary>
        /// Initializes a new instance of the ReportChairLoadFullTimeViewModel class.
        /// </summary>
        public ReportChairLoadFullTimeViewModel()
        {
            ...
            base.DisplayName = "Отчет Нагрузка кафедры - очное обучение";
        }
        ...
        private void GetLoadChairExecute()
        {
                ...
                (SelectedNameLoadChair != null))
            {
                ...
                loadChairTeaching = loadChairService.GetLoadChairTeachingFullTime(SelectedChair.Id, 
