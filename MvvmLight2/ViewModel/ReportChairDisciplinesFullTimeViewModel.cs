...
{
    public class ReportChairDisciplinesFullTimeViewModel : WorkspaceViewModel
    {
        private MvvmLight2.Helper.IContainer container = MvvmLight2.Helper.Container.Instance;

        ObservableCollection<tlsp_getDisciplineChairFullTime_Result> disciplines;

        #region SelectedChair

        /// <summary>
        /// Выделенная кафедра - Поле
        /// </summary>
        private Chair selectedChair;

        /// <summary>
        /// Выделенная кафедра - Свойство
        /// </summary>
        ...
        public ObservableCollection<tlsp_getDisciplineChairFullTime_Result> Disciplines { get; private set; }
        ...
        /// <summary>
        /// Initializes a new instance of the ReportChairDisciplinesFullTimeViewModel class.
        /// </summary>
        public ReportChairDisciplinesFullTimeViewModel(IServiceDisciplineChair service)
        {
            Disciplines = new ObservableCollection<tlsp_getDisciplineChairFullTime_Result>(); 
            base.DisplayName = "Отчет Дисциплины кафедры - очное обучение";
        }
        ...
        public void GetExecuteDisciplines()
        {
            ...
            if ((SelectedChair != null) && (SelectedAcademicYear != null))
            {
                ...
                worker.DoWork += (o, ea) =>
                {
                    disciplines = service.GetDisciplineFullTime(selectedChair.Id, selectedAcademicYear.Id);
                };
